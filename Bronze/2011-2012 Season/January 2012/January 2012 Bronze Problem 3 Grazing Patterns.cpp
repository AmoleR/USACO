...
int selfNonIntersectingWalks(int start1, int start2, int remaining) {
	//Variable to return
	int count;
	...
	//Then, we do the recursive sum
	count = selfNonIntersectingWalks(start1 - 1, start2, remaining - 1) + selfNonIntersectingWalks(start1 + 1, start2, remaining - 1) + selfNonIntersectingWalks(start1, start2 - 1, remaining - 1) + selfNonIntersectingWalks(start1, start2 + 1, remaining - 1);
...
int main() {
	...
	cout << selfNonIntersectingWalks(0, 0, (25 - K));
}